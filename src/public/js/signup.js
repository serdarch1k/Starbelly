...
/**=============== SHOW HIDDEN - REPEAT PASSWORD ===============**/
const showHiddenRepeatPass = (signupRepeatPass, signupRepeatEye) => {
  const input = document.getElementById(signupRepeatPass),
    iconEye = document.getElementById(signupRepeatEye);
...
showHiddenRepeatPass("signup-repeat-pass", "signup-repeat-eye");
